    ...
    def save_file(self):
        ...
        if save_path:
            try:
                ...
                img = Image.open(self.source_file).convert("RGBA")

                # Use multiple icon sizes including 256x256 for max quality
                ...
                QMessageBox.information(self, "Success", "Image successfully converted to high-quality ICO format!")
